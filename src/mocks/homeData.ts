export const emergencyBanner = {
  ...
  alerts: [
    ...
    "Crisis alimentaria en Catacaos: 250 niños con desnutrición crónica necesitan apoyo inmediato de alimentos nutritivos.",
    "Lluvias torrenciales destruyeron 8 escuelas rurales en Sullana. 380 niños sin clases. ¡Ayúdanos a reconstruir aulas YA!",
    "Brigadas médicas suspendidas en Morropón por falta de fondos. 95 madres gestantes y 40 bebés en riesgo de salud.",
    "Inundaciones en Sechura afectan 200 familias campesinas. Pierden cultivos y hogares. Necesitan ayuda de emergencia HOY.",
  ],
};
...
export const quienesSomosData = {
  ...
  image:
    "https://readdy.ai/api/search-image?query=Diverse%20group%20of%20Peruvian%20NGO%20volunteers%20standing%20together%20outdoors%20in%20a%20rural%20Andean%20community%2C%20all%20wearing%20matching%20dark%20wine-colored%20guinda%20vests%20over%20white%20polo%20shirts%2C%20warm%20natural%20golden%20hour%20light%2C%20mountains%20in%20background%2C%20friendly%20and%20professional%20team%20portrait%2C%20authentic%20documentary%20photography%20style%2C%20warm%20earthy%20tones&width=700&height=480&seq=equipo-ong-guinda-01&orientation=portrait",
  miniStats: [
  ...
  paragraphs: [
    ...
    `Semillas de Esperanza nació para ser ese puente. No venimos a dar soluciones desde afuera — venimos a <strong class="text-amber-300">caminar junto a las comunidades</strong>, escuchar sus necesidades y construir juntos un futuro más justo.`,
  ],
  quote: {
  ...
  testimonios: [
    {
      ...
      quote:
        "Cuando mi esposo se fue, quedé sola con tres hijos y sin saber cómo pagar el colegio. Semillas de Esperanza me enseñó a tejer y a vender mis productos. Hoy tengo mi propio negocio y mis hijos estudian. Nunca pensé que podría lograrlo.",
...
export const proyectosData = {
  ...
  proyectos: [
    ...
    {
      id: 2,
      title: "Brigadas de Salud Materna — Sullana",
      description:
        "Brigadas médicas mensuales para atención prenatal, parto seguro y control pediátrico en 12 comunidades rurales del distrito de Sullana.",
      category: "Salud",
      icon: "ri-heart-pulse-line",
      recaudado: 22400,
      meta: 28000,
    ...
    {
      id: 4,
      title: "Huertos Familiares — Morropón",
      description:
        "Implementación de 200 huertos familiares con técnicas de riego por goteo y conservación de semillas nativas en el distrito de Morropón para garantizar seguridad alimentaria.",
    ...
    {
      id: 5,
      title: "Raíces Vivas — Piura",
      description:
        "Recuperación de tradiciones, danzas y saberes ancestrales del norte peruano a través de escuelas culturales comunitarias en 8 centros poblados del distrito de Piura.",
      category: "Cultura",
      icon: "ri-palette-line",
      recaudado: 11200,
      meta: 15000,
    ...
    {
      id: 6,
      title: "Techo Digno — Sechura",
      description:
        "Mejoramiento de 60 viviendas en comunidades rurales del distrito de Sechura: instalación de agua potable, letrinas y techos resistentes para familias vulnerables.",
      category: "Vivienda",
...
export const apadrinamientoData = {
  ...
  carruselNinos: [
    ...
    },
    {
      ...
      caption: "Luis y Rosa, 7 y 4 años · Sechura, Piura",
      speech:
    ...
    },
    {
      ...
      caption: "Pedro, 9 años · Huancabamba, Piura",
      speech:
    ...
    },
    {
      ...
      caption: "Sofía, 3 años · Ayabaca, Piura",
      speech:
...
export const transparenciaData = {
  ...
  informes: [
    ...
    { title: "Estados Financieros Auditados", year: "2023", size: "2.1 MB" },
    { title: "Reporte de Proyectos Q4", year: "2023", size: "1.5 MB" },
  ],
};
...
export const footerData = {
  ...
  copyright: "© 2024 Semillas de Esperanza. Todos los derechos reservados. RUC: 20601234567",
  legal: [
